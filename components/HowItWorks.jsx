...
const HowItWorksSection = () => {
  return (
    <div className="text-white py-16 px-5 bg-cover bg-center h-[590px] [@media(width>=1500px)]:h-[725px]">
      {/* Background Image */}
      <Image
        src={sky}
      ...
      <div className="container mx-auto relative">
        <h2 className="text-start md:text-center text-2xl font-normal mb-8 font-primary">
          How it works
        </h2>
